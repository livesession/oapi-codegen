...
import (
	...
	"github.com/livesession/oapi-codegen/v2/examples/authenticated-api/stdhttp/api"
	"github.com/livesession/oapi-codegen/v2/examples/authenticated-api/stdhttp/server"
)

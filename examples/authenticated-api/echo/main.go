...
import (
	...
	"github.com/livesession/oapi-codegen/v2/examples/authenticated-api/echo/api"
	"github.com/livesession/oapi-codegen/v2/examples/authenticated-api/echo/server"
)

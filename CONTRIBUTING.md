...
We'd prefer that questions about "how do I use (this feature)?" or "what do the community think about ...?" get asked using [GitHub Discussions](https://github.com/livesession/oapi-codegen/discussions) which allow the community to answer them more easily.

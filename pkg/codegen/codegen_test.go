...
const (
	remoteRefFile = `https://raw.githubusercontent.com/livesession/oapi-codegen/master/examples/petstore-expanded` +
		`/petstore-expanded.yaml`
	remoteRefImport = `github.com/livesession/oapi-codegen/v2/examples/petstore-expanded`
)
...
func TestRemoteExternalReference(t *testing.T) {
	...
	// Check import
	assert.Contains(t, code, `externalRef0 "github.com/livesession/oapi-codegen/v2/examples/petstore-expanded"`)
